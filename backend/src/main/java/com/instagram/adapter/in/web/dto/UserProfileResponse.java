...
public record UserProfileResponse(
    ...
    @Schema(description = "Number of posts created by the user", example = "42")
    int postCount,
    
    @Schema(description = "Number of followers", example = "1000")
    int followerCount,
    
    @Schema(description = "Number of accounts the user is following", example = "500")
    int followingCount,
    
    @Schema(description = "Whether the current authenticated user is following this user", example = "true")
    boolean isFollowing
) {
