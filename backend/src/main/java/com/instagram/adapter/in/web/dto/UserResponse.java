...
public record UserResponse(
    ...
    @Schema(description = "User's bio", example = "Photography enthusiast 📸")
    String bio,
    
    @Schema(description = "URL to the user's avatar image", example = "https://minio.local/avatars/123.jpg")
    String avatarUrl,
